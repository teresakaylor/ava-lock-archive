# 📚 Ava-Lock Archive: The Gift Hub Repository

Welcome to the **Ava-Lock Gift Hub**, the official long-term archive for the best of my creative works, assets, and web history associated with the pen name **'Ava Lock'**.

**Think of this as the "director's cut" archive—it's not everything, nor should it be!** This repository is dedicated to keeping my favorite works alive, including everything from old published books to some fun pieces that never made it out of the vault!

What remains of my old Amazon author profile can still be referenced here: [https://www.amazon.com/stores/Ava-Lock/author/B07F94VGC1](https://www.amazon.com/stores/Ava-Lock/author/B07F94VGC1)

## 🔗 The Archive: Web & Published Works

### 1. Website Archives (Wayback Machine)

While the original [AvaLock.com](https://avalock.com) is no longer active (domain for sale!), its history is preserved. Use the links below to travel back in time:

| Site | Link | Archived Date |
| :--- | :--- | :--- |
| **Repurposed Domain** | [Ava Lock's Bot Shop](https://web.archive.org/web/20250408164521/https://avalock.com/) | April, 2025 |
| **Old Author Site** | [Author Site](https://web.archive.org/web/20230210024609/https://avalock.com/) | February, 2023 |
...
* **Licensing:** All original works within this repository are provided for personal reading and archival purposes only. All copyrights remain with the original author.
* **Status:** This repository is in **archived status** (read-only) and is no longer being actively developed or updated with new content.
